...
- [x] Design document
- [ ] Initialize Next.js project (bun, package.json, tsconfig, next.config)
- [ ] Basalt design system (CSS tokens, shadcn/ui, layout)
- [ ] Tailwind v4 + postcss
- [ ] NextAuth v5 + Google OAuth + whitelist
- [ ] Badge Login page (from surety)
- [ ] App Shell (sidebar + header + empty dashboard)
- [ ] proxy.ts (Next.js 16 middleware)
- [ ] Husky + pre-commit + pre-push hooks
- [ ] ESLint + strict mode
- [ ] Test framework (bun test) + initial tests
- [ ] Dockerfile + .env.example + CLAUDE.md

### Phase 2: Project Management
- [ ] D1 client setup + schema initialization
- [ ] Project CRUD API
- [ ] Project management pages
- [ ] Webhook token generation & display
- [ ] AI agent integration prompt generation

### Phase 3: Backup Receiving (Webhook)
- [ ] Webhook endpoint (receive zip)
- [ ] Token verification
- [ ] Zip analysis (single json detection)
- [ ] R2 upload + D1 metadata insert
- [ ] Request metadata extraction (IP, environment, tag)

### Phase 4: Backup Management UI
- [ ] Backup list page (global, with filters)
- [ ] Project detail page (per-project backup list)
- [ ] Filter, search, sort
- [ ] Multi-select + batch operations
- [ ] Single backup operations (download, delete)
- [ ] Pagination
